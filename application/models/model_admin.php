...
public function bh_sms($mob_no, $msg)
    {
	...
	
{
   ...
   $urls= base_url();
	...
	if(isset($data['id'])){
	 ...
	 $mobile = $row1->phone;
	 $sms = "Ride ID: ".$row31->uneaque_id.", ".$row->name."/ ".$row->mobile.",Pick: ".$row31->pickup_area.", Pick Time: ".$row31->pickup_time."/".$row31->pickup_date.". ".$row31->package."/".$row31->amount." Tk";
	$this->bh_sms($mobile, $sms);
