...
public function searchs_p()
   ...
   $this->load->view('admin-add-point');
	...
	public function admin_book()
	{
	   ...
	   $messageText = 'Hello, Trip info: Pick Date:'.$pickup_date.' Area: '.$area.' Landmark: '.$landmark;
	   
	   $driver_details =$this->model_admin->get_driver_details($assigned_for);
	   $driverPhone = $driver_details->phone;
