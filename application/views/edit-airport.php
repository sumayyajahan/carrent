                 ...
                 <form role="form"  method="post" id="airport_reg">
                  ...
                  <div class="box-body">
                                         ...
                                         <div class="form-group">
                                           ...
                                           <input class="form-control regcom sample"  name="pickup_area" value="<?php echo $row->pickup_area; ?>">
                                         </div>
                                         <div class="form-group">
                                            <label>Drop Area</label>
                                           <input class="form-control regcom sample" name="drop_area"  value="<?php echo $row->drop_area; ?>">
                                         </div>
					 <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group-addon">
                          <i class="fa fa-clock-o"></i>
                                        ...
                                        <div class="form-group">
                                            <label>Area</label>
                                            <input class="form-control regcom sample" name="area" value="<?php echo $row->area; ?>">
                 ...
                 <h3 class="box-title"></h3>
                   ...
                   <div class="box-body">
					                     ...
					                     <div class="form-group">
                                            ...
                                            <input class="form-control  " name="landmark" value="<?php echo $row->flight_number; ?>">
