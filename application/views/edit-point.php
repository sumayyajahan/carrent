                  ...
                  <h3 class="box-title"></h3>
                        ...
                        <form role="form"  method="post" id="point_reg">
                           <div class="box-body">
                              <div class="form-group">
                                 ...
                                 <input class="form-control regcom"  name="pickup_area" value="<?php echo $row->pickup_area; ?>" >
                              </div>
                              <div class="form-group">
                                 <label>Drop Area</label>
                                 <input class="form-control regcom" name="drop_area"  value="<?php echo $row->drop_area; ?>" >
                              </div>
				   ...
				   <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right regcom datepicker"  name="pickup_date"  id="optionD" value="<?php echo $row->pickup_date; ?>" >
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
		           ...
		           <div class="bootstrap-timepicker">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control timepicker regcom" name="pickup_time"   value="<?php echo $row->pickup_time; ?>" >
                        <div class="input-group-addon">
                          <i class="fa fa-clock-o"></i>
                              ...
                              <div class="form-group">
                                 ...
                                 <input class="form-control " name="taxi_type" value="<?php echo $row->taxi_type; ?>">
                              </div>
                              <div class="form-group">
                                 <label>Area</label>
                              ...
                              <div class="form-group">
                                 ...
                                 <input class="form-control " name="landmark" value="<?php echo $row->landmark; ?>">
                              </div>
                              <div class="form-group">
                        ...
                        <!-- form start -->
                           ...
                           <div class="box-body editpoint_height">
                              <div class="form-group">
                                 ...
                                 <input class="form-control" name="pickup_address" value="<?php echo $row->pickup_address; ?>">
                              </div>
                              <div class="form-group">
                                 <label>Promo Code</label>
                                 <input class="form-control " name="promo_code" value="<?php echo $row->promo_code; ?>">
                              </div>
                              <div class="form-group">
                                 <label>Payment Status</label>
                                 <input class="form-control " name="item_status" value="<?php echo $row->item_status; ?>">
                              </div>
                              <div class="form-group">
                                 <label>Transaction</label>
                                 <input class="form-control " name="transaction" value="<?php echo $row->transaction; ?>">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <select id="assigned" class="form-control select2 regcom"  style="width: 100%;" name="assigned_for">
                                    ...
                                    <?php
                                       ...
                                       $query1 = $this->db->query("SELECT driver_details.* FROM driver_details where NOT EXISTS(select * from bookingdetails where driver_details.id=bookingdetails.assigned_for and bookingdetails.status='Processing'  ) and user_status!='Inactive' ");
