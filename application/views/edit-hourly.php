	 ...
	 ?>
      ...
      <div class="content-wrapper">
        ...
        <!-- Main content -->
		 ...
		 $query1 = $this->db->query("SELECT * FROM `package_details` WHERE `id` = '$id'");
         $row1 = $query1->row('package_details');
								?>
                <form role="form"  method="post" id="hourly_reg">
                  ...
                  <div class="box-body">
                                            ...
                                            <label>Package</label>
                                           <input class="form-control regcom" name="package"  value="<?php 
                                           echo $row1->package; ?>">
                                        </div>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right regcom datepicker"  name="pickup_date" value="<?php echo $row->pickup_date; ?>">
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->            
                                 ...
                                 <label>Payment Status</label>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
											...
											if( $row->assigned_for){
												 $id =$row->assigned_for;
												$querys = $this->db->query("SELECT * from driver_details WHERE id='$id'");
