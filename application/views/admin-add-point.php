			  ...
			  <div class="col-lg-6">
                ...
                <!-- form start -->
                  ...
                  <div class="box-body">
										...
										$query1 = $this->db->query("SELECT * FROM cabdetails LEFT JOIN car_categories ON cabdetails.cartype=car_categories.car_type WHERE transfertype='Point to Point Transfer' group by cabdetails.cartype");
