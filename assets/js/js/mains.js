...
$(document).ready(function(){
	...
	if(access) {
...

            {
                ...
                var pickup_date = $("#datepicker3").val();
                        
                var pickup_location = $("#pickup_hourly").val();
                ...
                $.ajax({	
                    ...
                    data: {type:'Hourly Rental',shift:shift,pick_lat:pick_lat,pick_lng:pick_lng,hour_package:hour_package,pickup_date:pickup_date,pickup_location:pickup_location},
